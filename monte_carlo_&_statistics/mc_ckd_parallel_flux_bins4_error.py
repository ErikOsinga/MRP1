...
# Simulate different flux thresholds
...
for run in range(100):
	...
	error = np.random.normal(0,5,len(ndata)) # add gaussian noise centered on the PA with std 5.
	ndata['position_angle'] += error

	monte_carlo(ndata,totally_random=False,filename='flux_bins4_error_%.1f' % run )
