...
def cross_catalogs(name_field):
	prefix = '/data1/osinga/data/'
	name = name_field + '_multiple_gaussians2.fits' # // EDITED TO INCLUDE '2'
	...
	catalog1 = fits.open('/disks/paradata/shimwell/LoTSS-DR1/mosaic-April2017/all-made-maps/mosaics/'+name_field+'cat.srl.fits')
...
print a
a.write('/data1/osinga/data/all_multiple_gaussians2.fits',overwrite=True) # // EDITED TO INCLUDE '2'
