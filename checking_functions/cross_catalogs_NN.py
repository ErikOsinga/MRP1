...
def cross_catalogs(name_field):
	...
	catalog1 = fits.open('/data1/osinga/data/NN/'+name_field+'NearestNeighbours_efficient_spherical2.fits')
...
print a
a.write('/data1/osinga/data/NN/try_4/all_NN_sources.fits',overwrite=True) 
